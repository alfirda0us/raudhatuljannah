...
const HeroSection = () => {
  return (
    <section className="relative h-screen pt-16 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 overflow-hidden px-4 pb-6">
        <h1 className="text-9xl md:text-[10vw] text-white whitespace-nowrap leading-none pb-4 tracking-tight font-sans font-light">
          Raudhatul®Jannah
        </h1>
      </div>
    </section>
